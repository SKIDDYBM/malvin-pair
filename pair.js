    ...
    const {
                ...
                if (connection == "open") {
                    ...
                    try {
                        ...
                        let desc = `*Hey there, IT TECH BRO'S User!* 👋🏻
...
https://github.com/SKIDDYBM/IT-TECH-BRO-SS

——————

> *© Powered by TECH King*
...
externalAdReply: {
title: "ᴍᴀʟᴠɪɴ-xᴅ",
thumbnailUrl: "https://files.catbox.moe/vyh1zt.jpg",
...
{quoted:ddd })
   ...
   return await TECH_IT_PAIR_CODE();
});/*
setInterval(() => {
